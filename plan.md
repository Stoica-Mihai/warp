...
- **cloud_preferences Increment B** — remove the now-dead `CloudPreference` cloud-object model (cross-crate: settings/cloud_preferences.rs + cloud_object ServerCloudObject::Preference variant + persistence arm). Mapped in §"cloud_preferences strip" below. Genuine remaining TODO.
