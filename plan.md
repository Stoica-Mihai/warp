...
| Cloud preferences syncer | `app/src/settings/cloud_preferences.rs` | 1 file, ~250 LoC | **MEDIUM** | 🔄 Inc A done (`7fb92e80`, toggle removed). Inc B remaining (cloud-object model, cross-crate). See "cloud_preferences strip" below. |
