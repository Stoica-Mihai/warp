...
1. **AIClient** (safest, AI already gutted) — remove consumers feature-by-feature then trait+impl+get_ai_client+the gql ops. PROGRESS:
   ...
   - **(1e)** delete AIClient trait/impl/get_ai_client + ServerApiProvider::get_ai_client once get_request_limit_info goes with 1a-iv (AIClient will be empty). GetRequestLimitInfo gql op too.
