...
- [~] **R5 batch-2b** — the 5 HIGH-FANOUT guarded flags (each on-by-default → gated code is currently live; collapse to off = real feature removal). 1 of 5 done:
  ...
  - [ ] **AgentView(17)**, **AgentMode(24 — keystone AI master-switch; determine on/off FIRST; collapsing cascades enormously across the whole agent surface)**. Do AgentMode LAST. HOANotifications/OpenCode/Codex/Gemini notification flags = vendor-CLI infra, KEEP.
