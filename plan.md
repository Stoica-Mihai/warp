...
**STEP 2/3 — verified classification (session 57 investigator, AIConversation has ZERO production constructors; all `AIConversation::new*` are test-only).** External `AIConversation`-type refs to neuter (then delete cluster):
