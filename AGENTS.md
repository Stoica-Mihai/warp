...
**Next**: login pass (relocate ~470 LoC from `crates/onboarding` into `auth/`, delete the crate; then drop firebase together with the auth/server layer). README rebrand parked.
