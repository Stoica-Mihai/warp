...
use crate::cloud_object::{
    ...
    Revision, RevisionAndLastEditor, GENERIC_STRING_OBJECT_PREFIX,
    JSON_OBJECT_PREFIX,
};
                ...
                metadata_by_id
                    ...
                    .and_then(|metadata| {
                        ...
                        object_id.and_then(|server_id| match json_object_type {
                            ...
                            JsonObjectType::EnvVarCollection => None,
...
fn to_cloud_object_permissions(
    ...
    // Object sharing (guests / anyone-with-link) is not supported in this fork.
