...
use warpui::elements::{
    ...
    DragAxis, DragBarSide, Draggable, DropShadow, DropTarget, Element, Empty,
    Fill as ElementFill, Flex, Hoverable, MainAxisAlignment, MainAxisSize,
...
fn render_settings_button(
    ...
    let button = Hoverable::new(
        ...
        move |hover_state| {
            let icon = ConstrainedBox::new(WarpIcon::Settings.to_warpui_icon(sub_text).finish())
                .with_width(16.)
                .with_height(16.)
                .finish();
