...
use super::ssh::util::{InteractiveSshCommand, SshWarpifyCommand};
...
impl TerminalView {
            ...
            ctx.subscribe_to_model(&mgr_handle, |me, _, event, ctx| {
                ...
                match event {
                    ...
                    RemoteServerManagerEvent::SessionDeregistered { session_id } => {
                        // Clean up any stale failure banner if the session
    ...
    fn maybe_send_agent_exited_shell_telemetry(&self, _ctx: &mut ViewContext<Self>) {}
...
impl TerminalView {
    ...
    fn update_input_prompt_suggestions_banner_state(&mut self, _ctx: &mut ViewContext<Self>) {}
